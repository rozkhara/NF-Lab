...
namespace Tool
{
    ...
    {
        private static readonly Dictionary<string, AsyncOperationHandle> LoadedDict = new Dictionary<string, AsyncOperationHandle>();

        /// <summary>
        /// Assets/Prefabs 아래의 프리팹을 로드하는 루틴을 리턴한다.
        /// </summary>
        ...
        /// <summary>
        /// Assets/Prefabs 아래의 프리팹을 로드하고 로드가 끝날 때까지 기다린다. (여러 개를 연속으로 로드할 때 쓰면 심각한 퍼포먼스 저하가 있을 수도 있음)
        /// </summary>
